...
class CommentHandler(object):
        ...
        for comment in comments:
            ...
            if tmp!="":
                ...
                if(tmplist[0]=="append"):
                    ...
                    print(reviewdate)
                    # try:
                    comment_author = html.find('a',attrs={"data-hook":"review-author"})
    ...
    def get_profile_info(self,url):
        ...
        try:
            ...
            tmp = open("tmp2.html","w+")
            tmp.write(htmltxt.decode(encoding="utf-8"))
            tmp.close()
            exit(1)
        name = jsonobj["nameHeaderData"]["name"]
        print("name:"+name)
        reviewRank = jsonobj['bioData']['topReviewerInfo']['rank']
        print(reviewRank)
...
def main():
    ch = CommentHandler("https://www.amazon.co.uk","B00WSKNBFQ",4,3,True)
